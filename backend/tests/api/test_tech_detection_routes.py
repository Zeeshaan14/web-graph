...
class TestDetectTechRoute:
    def test_calls_pipeline_with_the_submitted_url_and_returns_its_result(self):
        with patch("api.routes.tech_detection.detect_website_technologies", return_value=SUCCESS_RESULT) as mock_detect:
    ...
    def test_passes_through_a_failed_pipeline_result_as_200_not_500(self):
        ...
        with patch("api.routes.tech_detection.detect_website_technologies", return_value=FAILED_RESULT):
    ...
    def test_missing_url_field_is_rejected_before_pipeline_is_called(self):
        with patch("api.routes.tech_detection.detect_website_technologies") as mock_detect:
